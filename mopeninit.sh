...
sudo pacman -S menumaker lxsession lxappearance-gtk3 arc-gtk-theme xarchiver xterm base-devel nitrogen firefox git geany --noconfirm
...
sudo pacman -S deadbeef unzip wget jgmenu orage --noconfirm
